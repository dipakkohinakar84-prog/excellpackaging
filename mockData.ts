...
export const MOCK_USERS: User[] = [
  ...
  { id: 2, username: 'Atul Khandge', email: 'admin@a', mobile: '9881110047', passkey: 'pass123', department: 'Manager', level: '1-Manager' },
...
export const MOCK_ITEMS: Item[] = [
  { 
    ...
    children: [
      // Fix: Corrected 'department' to 'departments' array to match ChildItem type
...
export const MOCK_WORK_ORDERS: WorkOrder[] = [
  ...
  { id: 1113, customer: 'Diam Display India Pvt Ltd', job_details: 'WOOD_C1_GONDOLA_WOODEN_CRATE', drawing: 'N/A', qty: 10, etd: '2026-02-11', ready_date: '', status: 'Not Started', assigned_departments: ['Wood_Work'] },
];
